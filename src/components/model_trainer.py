...
class ModelTrainer:
    ...
    def get_best_model(self, x_train:np.array, x_test:np.array,y_train:np.array, y_train:np.array):
        try:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        ...
        try:
            ...
            best_model = self.finetune_best_model(
                best_model_name= best_mode_name,
            ...
            print(f'best_model name {best_model_name} and score : {best_model_score}')
